  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application, your ultimate platform for streamlining human resources processes, enhancing productivity, and fostering workplace harmony."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application, your ultimate platform for streamlining human resources processes, enhancing productivity, and fostering workplace harmony.`}
            </Text>
            <Box
